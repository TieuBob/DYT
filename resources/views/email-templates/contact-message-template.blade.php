...
<body>
    <div
        style="display:none; max-height:0px; overflow:hidden; font-size:1px; line-height:1px; color:#ffffff; opacity:0;">
        ...
        <tr>
            <td align="center">
                <table role="presentation" class="email-body" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="background:#ffffff; padding:18px 24px; border-bottom:1px solid #f0f0f0;">

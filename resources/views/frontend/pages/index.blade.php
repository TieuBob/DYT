                        ...
                        <div class="row">
                                    ...
                                    <div class="js-slick-carousel u-slick overflow-hidden"
                                        ...
                                        <div class="js-slide">
                                            <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                                    src="/frontend/assets/img/1500X730/img1.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="js-slide">
                                            <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                                    src="/frontend/assets/img/1500X730/img2.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="js-slide">
                                            <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                                    src="/frontend/assets/img/1500X730/img3.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="js-slide">
                                            <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                                    src="/frontend/assets/img/1500X730/img4.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                        <div class="js-slide">
                                            <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                                    src="/frontend/assets/img/1500X730/img5.jpg"
                                                    alt="Image Description"></a>
                                        </div>
                                    </div>
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">Robot Wars – Post with
                                                Gallery</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">Design,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">
                                                    Technology,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> News,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> Videos</a>
                                                <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i
                                                        class="fas fa-circle"></i></span>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">March 4,
                                                    2016</a>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    ...
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">Robot Wars – Now Closed – Post
                                                with Audio</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                                                ...
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">
                                                    Technology,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> News,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> Audio</a>
                                                <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i
                                                        class="fas fa-circle"></i></span>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">March 4,
                                                    2016</a>
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                            src="/frontend/assets/img/1500X730/img9.jpg" alt="Image Description"></a>
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">Robot Wars – Now Closed – Post
                                                with Video</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                ...
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">
                                                    Technology,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> News,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> Video</a>
                                                <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i
                                                        class="fas fa-circle"></i></span>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">March 4,
                                                    2016</a>
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">Announcement – Post without
                                                Image</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                                                ...
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">
                                                    Technology,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> News,</a>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5"> Image</a>
                                                <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i
                                                        class="fas fa-circle"></i></span>
                                                <a href="single-blog-post.html" class="mx-0dot5 text-gray-5">March 4,
                                                    2016</a>
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                            src="/frontend/assets/img/1500X730/img6.jpg" alt="Image Description"></a>
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">Robot Wars – Now Closed</a>
                                        </h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                            src="/frontend/assets/img/1500X730/img7.jpg" alt="Image Description"></a>
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">SpaceX Falcon explodes after
                                                Landing</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    ...
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">The first flowers in space</a>
                                        </h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-13 border-0">
                                    <a href="single-blog-post.html" class="d-block"><img class="img-fluid"
                                            src="/frontend/assets/img/1500X730/img8.jpg" alt="Image Description"></a>
                                    <div class="card-body pt-5 pb-0 px-0">
                                        <h4 class="mb-3"><a href="single-blog-post.html">HoloLens technical details
                                                emerge</a></h4>
                                        <div class="mb-3 pb-3 border-bottom">
                                            <div
                                                class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                            ...
                            <div class="col-lg-6">
                                <article class="card mb-8 border-0">
                                    <div class="card-body p-5 p-md-10 bg-gray-1">
                                        ...
                                        <a href="single-blog-post.html" class="text-blue">http://wwww.transvelo.com</a>
                                    </div>
                                </article>
                            </div>
                        </div>

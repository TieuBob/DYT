                ...
                <div class="my-md-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-3 flex-nowrap flex-xl-wrap overflow-auto overflow-xl-visble">
                            ...
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="#">Accessories</a>
                            </li>
                            <li class="breadcrumb-item flex-shrink-0 flex-xl-shrink-1"><a href="#">Headphones</a>
                            </li>
                ...
                <div class="row">
                    <div class="col-md-5 mb-4 mb-md-0">
                        <div id="sliderSyncingNav" class="js-slick-carousel u-slick mb-2" data-infinite="true"
                            ...
                            <div class="js-slide">
                                <img class="img-fluid" src="/frontend/assets/img/720X660/img1.jpg" alt="Image Description">
                            </div>
                            <div class="js-slide">
                                <img class="img-fluid" src="/frontend/assets/img/720X660/img2.jpg" alt="Image Description">
                            </div>
                            <div class="js-slide">
                                <img class="img-fluid" src="/frontend/assets/img/720X660/img3.jpg" alt="Image Description">
                            </div>
                            <div class="js-slide">
                                <img class="img-fluid" src="/frontend/assets/img/720X660/img4.jpg" alt="Image Description">
                            </div>
                            <div class="js-slide">
                                <img class="img-fluid" src="/frontend/assets/img/720X660/img5.jpg" alt="Image Description">
                            </div>
                        </div>
                            ...
                            <div class="border-bottom mb-3 pb-md-1 pb-3">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <a href="#" class="max-width-150 ml-n2 mb-2 mb-md-0 d-block"><img
                                            class="img-fluid" src="/frontend/assets/img/200X60/img1.png"
                        ...
                        <div class="tab-pane fade active show" id="Jpills-two-example1" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <img class="img-fluid mr-n4 mr-lg-n10" src="/frontend/assets/img/580X580/img1.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="col-md-6 text-left">
                                    <img class="img-fluid ml-n4 ml-lg-n10" src="/frontend/assets/img/580X580/img2.jpg"
                                        alt="Image Description">
                                </div>

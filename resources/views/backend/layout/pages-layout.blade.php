    ...
    <div class="header">
        ...
        <div class="header-right">
            ...
            <div class="github-link">
                <a href="https://github.com/TieuBob/" target="_blank"><img src="/backend/vendors/images/github.svg"
                        alt="" /></a>
            </div>
        </div>
    </div>
                    ...
                    @if (auth()->user()->type == 'superAdmin')
                        <li>
                            <a href="{{ route('admin.categories') }}"
                                ...
                                <span class="micon bi bi-list"></span><span class="mtext">Categories</span>
                            </a>
                        </li>
                    @endif
                    <li class="dropdown">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="{{ route('admin.posts') }}"
                                    class="{{ Route::is('admin.posts') ? 'active' : '' }}">Pots</a></li>
                        </ul>
                    </li>
                    @if (auth()->user()->type == 'superAdmin')
                        <li class="dropdown">
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            ...
            <div class="footer-wrap pd-20 mb-20 card-box">
                ...
                <a href="https://github.com/TieuBob/" target="_blank">Bob</a>
            </div>
        </div>
    </div>
    <!-- js -->
